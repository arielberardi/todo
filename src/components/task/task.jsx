...
import { deleteTodo, updateTodo } from '../../slices/todo_list_slice.js';

import TodoModal from '../todo_modal/todo_modal.jsx';
import AwesomeButton from '../awesome_button/awesome_button.jsx';
...
const Task = ({ todo }) => {
  ...
  return (
    <div className='task-container'>
      ...
      <TodoModal action='update' modalOpen={modalOpen} setModalOpen={setModalOpen} todo={todo} />
    </div>
  );
};
